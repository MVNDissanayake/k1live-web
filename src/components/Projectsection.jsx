    ...
    <section id="projects" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
          {" "}
          Featured <span className="text-primary"> Live</span>
        </h2>

        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          From grand concerts to intimate weddings, 
          K1 Live brings energy, 
          music, and unforgettable moments to every stage.
        </p>
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            href="https://www.youtube.com/@k1Live_Srilanka"
          >
            Check YouTube <ArrowRight size={16} />
          </a>
        </div>
      </div>
    </section>
